...
LC_ADTEntry_t LC_DefaultADT[LC_MAX_ACTIONPOINTS] =
{
    ...
    /* #3 open louver if close to edge operating temp */
    {
        .DefaultState        = LC_APSTATE_ACTIVE,
        .MaxPassiveEvents    = 0,
        .MaxPassFailEvents   = 0,
    ...
    /* #4 close louver if close to edge operation temp */
    {
        .DefaultState        = LC_APSTATE_ACTIVE,
        .MaxPassiveEvents    = 0,
        .MaxPassFailEvents   = 0,
    ...
    /* #5 Set A active if B discharging,broken, leaking */
    {
        .DefaultState        = LC_APSTATE_ACTIVE,
        .MaxPassiveEvents    = 0,
        .MaxPassFailEvents   = 0,
    ...
    /* #6 Set B active if A discharging,broken, leaking */
    {
        .DefaultState        = LC_APSTATE_ACTIVE,
        .MaxPassiveEvents    = 0,
        .MaxPassFailEvents   = 0,
    ...
    /* #7 stop observation state if Cap A is active and charge is low */
    {
        .DefaultState        = LC_APSTATE_ACTIVE,
        .MaxPassiveEvents    = 0,
        .MaxPassFailEvents   = 0,
    ...
    /* #8 stop observation state if charge if Cap B is active and charge is low */
    {
        .DefaultState        = LC_APSTATE_ACTIVE,
        .MaxPassiveEvents    = 0,
        .MaxPassFailEvents   = 0,
